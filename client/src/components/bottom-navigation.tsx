import { Home, Calculator, Package, Users, BarChart, Settings, MenuBook, ShoppingBag } from "lucide-react";
...
export function BottomNavigation() {
  ...
  const navItems = [
    ...
    { path: "/cardapio", icon: MenuBook, label: "Cardápio", testId: "nav-cardapio" },
